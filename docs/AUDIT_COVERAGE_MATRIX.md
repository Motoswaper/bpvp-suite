...
| Supply-chain posture | Scorecards + keyless signing + release signature verification | `INFO - OSSF Scorecards`, `INFO - Provenance Signing`, wallet release gate | Covered |
...
3. Expand signed provenance verification from checksums-level to per-artifact attestations.
